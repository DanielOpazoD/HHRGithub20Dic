...
export interface DateStripProps
  extends DateNavigationProps, DateStripActionsProps, EmailConfigProps, SyncConfigProps {}
...
export const DateStrip: React.FC<DateStripProps> = ({
  ...
  useEffect(() => {
    ...
    const onWheel = (event: WheelEvent) => {
      // Register listener as non-passive so preventDefault is legal and
      // browser does not throw "Unable to preventDefault inside passive event listener invocation".
        ...
        <div className="flex items-center gap-3">
          ...
          {onSendEmail && (
            <button
              ...
              title={
                emailStatus === 'error'
                  ? emailErrorMessage || 'Ocurrió un error al enviar el correo'
                  : 'Enviar censo por correo'
              }
            >
              <Send size={14} />
              {emailStatus === 'loading'
