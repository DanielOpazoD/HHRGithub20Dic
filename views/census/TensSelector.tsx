            ...
            <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex gap-1 flex-wrap">
                    {[0, 1, 2].map(idx => (
                        <select
                            key={`day-${idx}`}
                            className="py-0.5 px-1 border border-slate-200 rounded text-[10px] focus:ring-1 focus:ring-teal-500 focus:outline-none w-[68px] bg-teal-50/40 text-slate-700 h-6"
            ...
            <div className="flex items-center gap-2 flex-wrap">
                ...
                <div className="flex gap-1 flex-wrap">
                    {[0, 1, 2].map(idx => (
                        <select
                            key={`night-${idx}`}
                            className="py-0.5 px-1 border border-slate-200 rounded text-[10px] focus:ring-1 focus:ring-slate-500 focus:outline-none w-[68px] bg-slate-100/50 text-slate-700 h-6"
