...
export const HandoffNovedades: React.FC<HandoffNovedadesProps> = ({ value, onChange }) => {
    ...
    return (
        <div className="bg-white border border-slate-200 rounded-lg p-4 mt-6 print:border-none print:p-2 print:mt-4 print:bg-transparent print:text-[10px] print:leading-snug">
            <h3 className="font-bold text-lg text-slate-700 mb-2 flex items-center gap-2 print:text-sm print:mb-1.5 print:text-black">
            ...
            <div className="hidden print:block whitespace-pre-wrap text-slate-800 text-sm print:text-[10px] print:leading-snug">
